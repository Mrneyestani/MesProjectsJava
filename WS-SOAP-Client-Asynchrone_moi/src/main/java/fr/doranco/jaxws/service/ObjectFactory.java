...
public class ObjectFactory {
    ...
    private final static QName _AddEtudiant_QNAME = new QName("http://service.jaxws.doranco.fr/", "addEtudiant");
    private final static QName _Exception_QNAME = new QName("http://service.jaxws.doranco.fr/", "Exception");
    private final static QName _GetEtudiants_QNAME = new QName("http://service.jaxws.doranco.fr/", "getEtudiants");
    private final static QName _AddEtudiantResponse_QNAME = new QName("http://service.jaxws.doranco.fr/", "addEtudiantResponse");
    private final static QName _GetEtudiantsResponse_QNAME = new QName("http://service.jaxws.doranco.fr/", "getEtudiantsResponse");
    private final static QName _GetEtudiantById_QNAME = new QName("http://service.jaxws.doranco.fr/", "getEtudiantById");
    private final static QName _GetEtudiantByIdResponse_QNAME = new QName("http://service.jaxws.doranco.fr/", "getEtudiantByIdResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.jaxws.doranco.fr/", name = "addEtudiant")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.jaxws.doranco.fr/", name = "getEtudiants")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.jaxws.doranco.fr/", name = "addEtudiantResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.jaxws.doranco.fr/", name = "getEtudiantsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.jaxws.doranco.fr/", name = "getEtudiantById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.jaxws.doranco.fr/", name = "getEtudiantByIdResponse")
